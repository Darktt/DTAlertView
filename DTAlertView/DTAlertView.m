...
- (void)setViews {
	...
	if ((_cancelButtonTitle != nil && [_positiveButtonTitleArray count] == 1) || [_positiveButtonTitleArray count] == 2) {
...
// Positive Button
	if (_positiveButtonTitleArray != nil) {
		for (int positiveButtonIndex = 0; positiveButtonIndex < [_positiveButtonTitleArray count]; positiveButtonIndex++) {
			...
			if (_cancelButtonTitle != nil && [_positiveButtonTitleArray count] == 1) {
			...
			else if (_cancelButtonTitle == nil && [_positiveButtonTitleArray count] == 2 && positiveButtonIndex == 1) {
				positiveButtonFrame.origin.x = buttonWidth + 1.0f;
			}
                ...
                positiveButtonFrame.origin.y = (buttonBackgroundView.frame.origin.y + buttonBackgroundView.frame.size.height) - (positiveButtonFrame.size.height * (positiveButtonIndex + 1)) - positiveButtonIndex  * 1.0f;
			}
